...
//func TestEvaluateTx(t *testing.T) {
//
//}

/*
func TestEvaluateTxResult(t *testing.T) {
	err := filepath.Walk("ext/ogmios/server/test/vectors/TxSubmission", testEvaluateTxResult(t))
	if err != nil {
		t.Fatalf("got %v; want nil", err)
	}
}

func testEvaluateTxResult(t *testing.T) filepath.WalkFunc {
	return func(path string, info fs.FileInfo, err error) error {
		t.Run(filepath.Base(path), func(t *testing.T) {
			...
			err = readEvaluateTx(data)
			var ste EvaluateTxError
